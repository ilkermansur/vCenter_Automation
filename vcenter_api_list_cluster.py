...
###
cluster_list_url = f"https://{vcenter_ip}/api/vcenter/cluster"
response = requests.get(url=cluster_list_url, headers={"vmware-api-session-id": session_id}, verify=False)
if response.status_code == 200:
